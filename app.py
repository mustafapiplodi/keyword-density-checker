...
def export_pdf():
    ...
    try:
        ...
        elements.append(Paragraph(
            "This report was generated by SEO Keyword Density Analyzer",
            ParagraphStyle('FooterGray', parent=styles['Normal'], fontSize=8,
                         textColor=colors.HexColor('#9ca3af'), alignment=TA_CENTER)
        ))
        elements.append(Spacer(1, 0.1*inch))
        elements.append(Paragraph(
            "Powered by Scaling High Technologies | www.scalinghigh.com",
            footer_style
        ))
