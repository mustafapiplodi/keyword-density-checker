...
def export_csv():
    ...
    try:
        ...
        # Add footer
        writer.writerow([])
        writer.writerow(['Powered by Scaling High Technologies | www.scalinghigh.com'])
...
def export_pdf():
    ...
    try:
        ...
        elements.append(Paragraph(
            "<para align=center fontSize=9 textColor='#1a56db'><b>Powered by Scaling High Technologies | www.scalinghigh.com</b></para>",
            styles['Normal']
        ))
