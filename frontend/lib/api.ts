...
export async function analyzeContent(
  ...
  if (data.target_keyword) {
    backendData.target_keyword = data.target_keyword
  }
  if (data.cluster_keywords !== undefined) {
    backendData.cluster_keywords = data.cluster_keywords
  }
  if (data.calculate_prominence !== undefined) {
    backendData.calculate_prominence = data.calculate_prominence
  }
